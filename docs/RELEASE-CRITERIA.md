...
| Complete build | Individual packages built during bring-up; host regression suite passes | Build every shipped package in a fresh ARM64 environment with recorded dependencies, logs and resulting hashes |
...
| Desktop and hardware | Accelerated Omarchy; several devices detected | Verify suspend/resume where supported, sustained workloads, networking, audible audio and Bluetooth pairing; document exclusions |
